...
class gps_rft_v1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "gps_rft_v1")
        ...
        self.gnss_acquisition_and_tracking_0_0_0_0 = gnss.acquisition_and_tracking(samp_rate)
        self.gnss_acquisition_and_tracking_0_0_0_0.set_acq_params(gnss.NAVIGATION_SYSTEM_GPS, 32)
        self.gnss_acquisition_and_tracking_0_0_0 = gnss.acquisition_and_tracking(samp_rate)
        self.gnss_acquisition_and_tracking_0_0_0.set_acq_params(gnss.NAVIGATION_SYSTEM_GPS, 20)
        self.gnss_acquisition_and_tracking_0_0 = gnss.acquisition_and_tracking(samp_rate)
