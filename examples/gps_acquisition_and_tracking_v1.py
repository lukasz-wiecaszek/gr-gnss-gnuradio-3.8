...
# Title: gps_acquisition_and_tracking_v1
...
class gps_acquisition_and_tracking_v1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "gps_acquisition_and_tracking_v1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("gps_acquisition_and_tracking_v1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "gps_acquisition_and_tracking_v1")
        ...
        self.gnss_ca_code_generator_1 = gnss.ca_code_generator_c(1, samp_rate, svid, gnss.CA_CODE_DOMAIN_TIME)
...
def main(top_block_cls=gps_acquisition_and_tracking_v1, options=None):
