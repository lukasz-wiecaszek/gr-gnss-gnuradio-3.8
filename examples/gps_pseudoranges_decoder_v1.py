...
class gps_pseudoranges_decoder_v1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.gnss_type_converter_0_0_0_0_0_0 = gnss.fc64_to_fc32(1)
        ...
        self.connect((self.gnss_acquisition_and_tracking_0_0, 0), (self.gnss_type_converter_0_0_0_0, 0))
        self.connect((self.gnss_acquisition_and_tracking_0_0_0, 0), (self.gnss_ca_sybmols_to_nav_bits_0_0_0, 0))
        self.connect((self.gnss_acquisition_and_tracking_0_0_0, 0), (self.gnss_type_converter_0_0_0_0_0, 0))
        self.connect((self.gnss_acquisition_and_tracking_0_0_0_0, 0), (self.gnss_ca_sybmols_to_nav_bits_0_0_0_0, 0))
        self.connect((self.gnss_acquisition_and_tracking_0_0_0_0, 0), (self.gnss_type_converter_0_0_0_0_0_0, 0))
        ...
        self.connect((self.gnss_ca_sybmols_to_nav_bits_0_0_0_0, 0), (self.gnss_nav_message_decoder_0_0_0_0, 0))
        ...
        self.connect((self.gnss_type_converter_0_0_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 0))
        self.connect((self.gnss_type_converter_0_0_0_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0_0, 0))
        self.connect((self.gnss_type_converter_0_0_0_0_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0_0_0, 0))
