...
class gps_nav_message_decoder_v1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "gps_nav_message_decoder_v1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("gps_nav_message_decoder_v1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "gps_nav_message_decoder_v1")
...
def main(top_block_cls=gps_nav_message_decoder_v1, options=None):
