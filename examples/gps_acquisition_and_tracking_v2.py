...
# Title: gps_acquisition_and_tracking_v2
...
class gps_acquisition_and_tracking_v2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "gps_acquisition_and_tracking_v2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("gps_acquisition_and_tracking_v2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "gps_acquisition_and_tracking_v2")
        ...
        self.gnss_ca_code_generator_1 = gnss.ca_code_generator_c(1, samp_rate, svid, gnss.CA_CODE_DOMAIN_FREQUENCY)
        ...
        self.connect((self.blocks_stream_to_vector_0_0, 0), (self.blocks_multiply_conjugate_cc_0, 1))
        ...
        self.connect((self.gnss_ca_code_generator_1, 0), (self.blocks_throttle_0_0_0, 0))
...
def main(top_block_cls=gps_acquisition_and_tracking_v2, options=None):
